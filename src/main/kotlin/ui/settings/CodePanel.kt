...
class CodePanel(private val project: Project) : JPanel() {
    ...
    val javaTemplateTextField = createLanguageTextField(JavaLanguage.INSTANCE,isVisible = false)
    val javaSampleTextField = createLanguageTextField(JavaLanguage.INSTANCE, isVisible = false, isEnabled = false)

    private val textFieldsMap = mapOf(
            FileType.JAVA to listOf(javaTemplateTextField, javaSampleTextField),
