...
private val JAVA_DEFAULT_TEMPLATE = "package ${Variable.PACKAGE_NAME.value};\n\n public class ${Variable.NAME.value}${Variable.SCREEN_ELEMENT.value}{}"
...
enum class FileType(val displayName: String, val extension: String, val defaultTemplate: String, val defaultFileName: String) {
    ...
    JAVA("Java", "java", JAVA_DEFAULT_TEMPLATE, KOTLIN_DEFAULT_FILE_NAME),
